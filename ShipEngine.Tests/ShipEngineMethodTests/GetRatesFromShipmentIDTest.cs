...
using ShipEngineSDK.GetRatesByShipmentID;
using System;
...
{
    public class GetRatesFromShipmentIDTest
    {
        public Params RatesParameters;

        public TestUtils TestUtils;

        public GetRatesFromShipmentIDTest()
        {
        ...
        [Fact]
        public async void ValidCreateLabelFromShipmentIDTest()
        {
            ...
            var result = await mockShipEngineFixture.ShipEngine.GetRatesByShipmentID(RatesParameters);
        ...
        public async void ValidateCustomSettingsAtMethodLevel()
        {
            ...
            await shipEngine.GetRatesByShipmentID(RatesParameters, methodConfig: customConfig);
        ...
        public async void InvalidRetriesInMethodCall()
        {
            ...
            var ex = await Assert.ThrowsAsync<ShipEngineException>(async () => await shipEngine.GetRatesByShipmentID(RatesParameters, methodConfig: new Config(apiKey: "12345", retries: -1)));
